...
export const NAV_ITEMS = [
  ...
  { href: '/dashboard/suppliers', label: 'Suppliers', icon: '🚚', permission: 'manageInventory' },
  { href: '/dashboard/device-units', label: 'Device Units', icon: '📱', permission: 'manageInventory' },
  { href: '/dashboard/device-lookup', label: 'Serial/IMEI Lookup', icon: '🔍', permission: 'manageInventory' },
